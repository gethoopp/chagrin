...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(children: [_buildHeaderBackground(), _buildLoginForm(size)]),
    );
  }
    ...
    return BlocListener<AuthCubit, AuthState>(
      listener: (context, state) {
        if (state is AuthSucces) {
          showCustomToast(context, state.data.message!, Colors.greenAccent);
        }

        if (state is AuthError) {
          showCustomToast(context, state.message, Colors.redAccent);
        }
      },
      child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          buildTextField(
                            onChanged: (value) {
                              context.read<AuthFormCubit>().onChangeUsername(
                                stateLogin.data!,
                                value,
                              );
                            },
                          ...
                          buildPasswordField(
                            onChanged: (value) {
                              context.read<AuthFormCubit>().onChangePassword(
                                stateLogin.data!,
                                value,
                              );
                            },
